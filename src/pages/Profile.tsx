              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <Icon name="Mail" className="mr-2 text-muted-foreground" size={16} />
                    <span className="text-muted-foreground">{user.email}</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <Icon name="Gamepad2" className="mr-2 text-muted-foreground" size={16} />
                    <span className="text-muted-foreground">{user.steamId}</span>
                  </div>
                </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {purchases.map((purchase) => (
                        <div key={purchase.id} className="flex items-center justify-between p-4 bg-muted rounded-lg">
                          <div className="flex-1">
                            <h4 className="font-semibold">{purchase.pluginName}</h4>
                      ...
                      {purchases.length === 0 && (
                        <div className="text-center py-12">
                          <Icon name="ShoppingBag" className="mx-auto text-muted-foreground mb-4" size={48} />
                          <h3 className="text-xl font-semibold mb-2">Покупок пока нет</h3>
                          <p className="text-muted-foreground mb-4">
                            Начните покупать плагины для улучшения вашего сервера
                          </p>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            Получать информацию о скидках и специальных предложениях
                          </div>
                        </div>
                        <Button variant="outline" size="sm">
                          Включить
