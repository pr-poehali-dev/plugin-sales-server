  ...
  const [reviews] = useState<Review[]>([
    {
      ...
      rating: 5,
      comment:
        "Отличный плагин! Значительно расширяет возможности строительства. Особенно нравится функция 3D предпросмотра. Разработчик активно поддерживает и обновляет плагин.",
      date: "20.09.2024",
      helpful: 12,
      verified: true,
    },
    {
      ...
      rating: 5,
      comment:
        "Использую на своем сервере уже полгода. Игроки в восторге от новых возможностей строительства. Никаких проблем с производительностью.",
      date: "18.09.2024",
      helpful: 8,
      verified: true,
    },
    {
      ...
      rating: 4,
      comment:
        "Хороший плагин, но есть небольшие баги с копированием больших структур. В целом рекомендую.",
      date: "16.09.2024",
      helpful: 5,
      verified: false,
    },
    {
      ...
      rating: 5,
      comment:
        "Лучший плагин для строительства! Даже новичок может создавать красивые постройки.",
      date: "14.09.2024",
      helpful: 3,
      verified: true,
    },
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-6 mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-muted-foreground">
                          {plugin.downloads.toLocaleString()} скачиваний
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="text-right">
                    ...
                    >
                      {inCart ? (
                        <>
                          <Icon name="Check" className="mr-2" size={20} />В
                          корзине
                        </>
                      ) : (
                        <>
                ...
                <div className="flex items-center space-x-4 p-4 bg-muted rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Последнее обновление: {plugin.lastUpdate}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground mt-2">
                        Основано на {plugin.totalReviews} отзывах
                      </p>
                    </div>

                    <div className="space-y-2">
                      {getRatingDistribution().map(
